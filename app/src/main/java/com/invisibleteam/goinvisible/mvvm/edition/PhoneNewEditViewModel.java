...
public class PhoneNewEditViewModel extends NewEditViewModel {

    private PhoneViewModelCallback callback;

    public PhoneNewEditViewModel(ImageDetails imageDetails, TagsManager tagsManager, PhoneViewModelCallback callback,
