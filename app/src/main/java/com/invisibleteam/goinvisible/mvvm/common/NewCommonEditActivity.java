...
public abstract class NewCommonEditActivity extends CommonActivity {

    public static final int PLACE_REQUEST_ID = 1;
    private NewEditActivityHelper editActivityHelper;
    ...
    protected void setEditActivityHelper(NewEditActivityHelper editActivityHelper) {
